...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        _create: function () {
            ...
            this.objs.layers.temporaryLink = $('<svg class="flowchart-temporary-link-layer" style="display:none!important;"></svg>');
        ...
        _getOperatorFullElement: function (operatorData) {
			...
			var $operator_body = $('<div style="padding: 10px;padding-top:0px;"></div>');
